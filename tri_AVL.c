...
int sort_T1(FILE* f, FILE* o, int r){
	...
	fprintf(o_T1,"# Id minimal_temperature maximal_temperature average_temperature\n");
	writeinfileNODE2_T1(o_T1, T_T1);
...
int sort_T2(FILE* f, FILE* o, int r){
	...
	FILE* o_T2=fopen("data/temp_T2.csv", "w");
	if(o_T2 ==NULL){
		printf("Can't open the file o\n");
		exit(3);
	}
	...
	fprintf(o_T2,"# Date average_temperature\n");
	writeinfileNODE2_T2(o_T2, T_T2);
...
int sort_T3(int r){
	...
	FILE* o_T3=fopen("data/temp_T3.csv", "w");
	if(o_T3 ==NULL){
		printf("Can't open the file o\n");
		exit(3);
	}
	T_T3 =fillNODE2_T3withNODE_T3(T_T3,l_T3, r);
	fprintf(o_T3,"# Day ID temperature hours\n");
	writeinfileNODE2_T3(o_T3, T_T3, addNODE_T3(NULL, 0, 0, 0, 0, 0, 0)->m);
...
int sort_P1(int r){
	...
	FILE* o_P1=fopen("data/temp_P1.csv", "w");
	if(o_P1 ==NULL){
		printf("Can't open the file o\n");
		exit(3);
	}
	...
	fprintf(o_P1,"# Id minimal_pressure maximal_pressure average_pressure\n");
	writeinfileNODE2_P1(o_P1, T_P1);
...
int sort_P2(int r){
	...
	FILE* o_P2=fopen("data/temp_P2.csv", "w");
	if(o_P2 ==NULL){
		printf("Can't open the file o\n");
		exit(3);
	}
	...
	fprintf(o_P2,"# Date average_pressure\n");
	writeinfileNODE2_P2(o_P2, T_P2);
...
int sort_P3(int r){
	...
	FILE* o_P3=fopen("data/temp_P3.csv", "w");
	if(o_P3 ==NULL){
		printf("Can't open the file o\n");
		exit(3);
	}
	...
	fprintf(o_P3,"# Day ID temperature hours\n");
	writeinfileNODE2_P3(o_P3, T_P3, addNODE_P3(NULL, 0, 0, 0, 0, 0, 0)->m);
...
int sort_W(int r){
	...
	FILE* o_W=fopen("data/temp_W.csv", "w");
	if(o_W ==NULL){
		printf("Can't open the file o\n");
		exit(3);
	}
	...
	fprintf(o_W,"# Longitude latitude rayon degré\n");
	writeinfileNODE2_W(o_W, T_W);
	freetreeNODE2_W(T_W);
	fclose(o_W);
...
int sort_H(int r){
	...
	FILE* o_H=fopen("data/temp_H.csv", "w");
	if(o_H ==NULL){
		printf("Can't open the file o\n");
		exit(3);
	}
	...
	fprintf(o_H,"# Longitude latitude height\n");
	writeinfileNODE2_H(o_H, T_H);
	freetreeNODE2_H(T_H);
	fclose(o_H);
...
int sort_M(int r){
	...
	FILE* o_M=fopen("data/temp_M.csv", "w");
	if(o_M ==NULL){
		printf("Can't open the file o\n");
		exit(3);
	}
	...
	fprintf(o_M,"# Longitude latitude moisture\n");
	writeinfileNODE2_M(o_M, T_M);
	freetreeNODE2_M(T_M);
	fclose(o_M);
